...
<div class="p-3">
    <?php if(session()->get('account')['status'] != 'belum' && session()->get('account')['status'] != 'ujian'): ?>
        <h1 class="text-2xl lg:text-3xl text-black font-bold">Review Ujian</h1>
    ...
    <?php else :?>
        ...
        <div class="p-3 bg-red-600 text-white text-xl font-semibold text-center shadow-lg rounded-md">
            <h1>SELESAIKAN UJIAN UNTUK DAPAT MELIHAT REVIEW</h1>
        </div>
    <?php endif ?>
</div>
<?= $this->endSection(); ?>